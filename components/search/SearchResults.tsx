        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          {isExpanded ? (
            <button
              ...
              className="rounded-full border border-white/15 bg-transparent px-6 py-2.5 text-sm font-medium text-brand-gray-300 tappable hover:bg-white/5 hover:text-white"
            >
              Show less
            </button>
          ) : null}
