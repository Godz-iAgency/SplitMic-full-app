...
export function buildSystemPrompt(
  ...
  return [
    ...
    "",
    "Never use an em dash (—) anywhere in your reply. Use a period, comma, or colon instead. Write plainly, the way a person texts a coworker, not the way a press release reads.",
  ]
    .filter(Boolean)
    .join("\n");
}
