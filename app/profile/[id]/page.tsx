    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-brand-gray-900 to-black pb-20">
      ...
      <div className="mx-auto max-w-5xl px-4 pt-6 sm:px-6 sm:pt-8">
        ...
        <div className="relative mb-20 sm:mb-24">
          <div className="aspect-[3/1] w-full overflow-hidden rounded-xl bg-brand-gray-900">
            {bannerUrl ? (
              ...
              <div className="relative h-full w-full bg-gradient-to-r from-brand-gray-900 via-black to-brand-gray-900">
                {isOwner ? (
                  <Link
                    href="/profile/edit"
          ...
          <div className="absolute bottom-0 left-5 translate-y-1/2 sm:left-8">
            <div className="h-28 w-28 overflow-hidden rounded-full ring-4 ring-black sm:h-32 sm:w-32">
              {avatarUrl ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img
                  src={avatarUrl}
        ...
        <section className="px-5 sm:px-8">
          ...
          {addressParts ? (
            <p className="mt-2 text-sm text-brand-gray-400">📍 {addressParts}</p>
          ) : null}
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            {profile.website_url ? (
              <a
                ...
                className="rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white transition hover:bg-white/10"
              >
                Website
              </a>
            ) : null}
